...
import { InViewport } from "@/components/commons/in-viewport/InViewport";
import {
...
export function PostImageCarousel({ postId, title }: PostImageCarouselProps) {
  ...
  const aspectRatioPlaceholder = (
    <div
      className={styles.placeholder}
      aria-hidden
      style={{
        aspectRatio: `${POST_DETAIL_IMAGE_WIDTH_PX} / ${POST_DETAIL_IMAGE_HEIGHT_PX}`,
      }}
    />
  );

  return (
    <InViewport fallback={aspectRatioPlaceholder} className={styles.inView}>
